  ...
  try {
    ...
    if (!originPlaceId || !destinationPlaceId) {
      return NextResponse.json(
        { success: false, message: "Origin and destination place IDs are required" },
        { status: 400 },
      )
    }

    console.log("Using Routes API with place IDs for distance calculation...")

    // Use the new Routes API with place IDs
